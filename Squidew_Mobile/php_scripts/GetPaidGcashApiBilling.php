...
if($query_response){
    ...
    creatBillingTransaction($total_amount, $fee_amount, $student_id,$connection, $student_name,$student_email,$student_mobile,$student_id,$description,$total_amount,$fee_amount,$hei_name);
    
}else{
    
}

function creatBillingTransaction($bills_total_amount, $bills_fee_amount, $bills_student_id, $connection, $student_name,$student_email,$student_mobile,$student_id,$description,$total_amount,$fee_amount,$hei_name){
  ...
  if(mysqli_query($connection,$create_billing_transaction_query)){
    ...
    if(mysqli_query($connection, $create_bills_transaction_query)){
      GENERATE_API_LINK($student_name,$student_email,$student_mobile,$student_id,$description,$total_amount,$fee_amount,$hei_name);
    }else{
      echo 'false'; 
    }
  }else{
...
function GENERATE_API_LINK($student_name,$student_email,$student_mobile,$student_id,$description,$total_amount,$fee_amount,$hei_name){
...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => array(
    ...
    'webhooksuccessurl' => 'https://google.com/',
