...
<head>
    ...
    <link rel="stylesheet" href="Styles/Cashier_side/cash_out_style.css" type="text/css" />
    ...
    <div class="side_nav_container" style="width: 240px;">
        ...
        <div class="main_data_container" style="flex: 60%;background: white;display: flex;flex-wrap: wrap; heigh">
            <div style="background:white;flex: 100%;margin: 0% 2% 5% 2%;height: 100%; flex-wrap: wrap;">
                <p style="background: white;color: black;font-size: 1.5rem;overflow: hidden;"><b>Cash Out</b></p>
                <div style="background: white;flex-wrap: wrap;">
                    <p style="flex: 60%;color: black;overflow: hidden;font-size: 1.2rem;">Latest <b>Cash Out</b></p>
                ...
                <form>
                    ...
                    <tr style="background: #0E203F; color: white;text-align: center; ">
                        <th style="width:10%; font-size:14px; " >Date & Time</th>
                        <th style="width:10%; font-size:14px;" >TransactionNo.</th>
                        <th style="width:10%; font-size:14px;" >ID No.</th>
                        <th style="width:42%; font-size:14px;" >Student Name</th>
                    
                        <th style="width:10%; font-size:14px;" >Bill type</th>
                ...
                <!-- cash outtables -->
                <div class="main_data_container" style="flex: 60%;background: white;display: flex;flex-wrap: wrap; overflow-x: hidden; overflow-y:auto; height: 43%">
                ...
                where transaction_type = '3' and wallet_name = 'Squidew Wallet' and hei.hei_id = '".$_SESSION['hei_id']."'";             
        ...
        <?php 
                    if(isset($_POST['datesearch'])){
                        ...
                        $query =    "select * from transaction
                            ...
                            inner join wallet on wallet.wallet_id = linked_card.wallet_id
                            inner join hei on hei.hei_id = student.hei_id
                            where transaction_type = '3' and wallet_name = 'Squidew Wallet' and (transaction.transaction_date BETWEEN '".$from_date."' AND '".$to_date."') and hei.hei_id = '".$_SESSION['hei_id']."'";
                    ...
                    <tr>
                        <td style="font-size:14px; text-align:left;  width:10%;"onclick="">
                            <?php echo $row['transaction_date'];?></td>
                        <td style="font-size:14px; text-align:left;  width:11.5%;"><?php echo $row['transaction_id'];?></td>
                        <td style="font-size:14px; text-align:left;  width:10%;"><?php echo $row['student_id'];?></td>
                        <td style="width:41%;; padding:10px; text-align:left; ">
                                    <b>
                        ...
                        <td style="font-size:14px; text-align:left;  width:9.5%;"><?php echo $row['transaction_type'];?></td>
                        <!-- <td><?php //echo $row['wallet_balance'];?></td> -->
                        <td style="font-size:14px; text-align:left;  width:10%;"><?php echo $row['transaction_amount'];?></td>
                        ...
                        <td style="width:8%;" >
                                    <div class="dropdown" style="margin: auto;">
                                            ...
                                            <div style>
                                                ...
                                                <input style="display: none;" type="text" name="search"  value="<?php echo $row['transaction_id'];?>" class="form-control">
                ...
                <form>
                                ...
                                <div style="margin-bottom: 5%;">
                                    ...
                                    <div  style="display:flex;flex-wrap: wrap;width: calc(100% - 1.2rem);height: 3%">
                                        ...
                                        <div style="display: flex;flex: 20%;">
                                            <input style="padding: 2.5%;" type="text" id="cash_out_student_id" name="Idno" placeholder="E.g 18229132" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div  style="display:flex;flex-wrap: wrap;width: calc(100% - 1.2rem);height: 3%">
                                        ...
                                        <div style="display: flex;flex: 20%;">
                                            <input style="padding: 2.5%;" type="number" step="any" id="cash_out_amount" name="amount"  placeholder="0.00" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div style="display: block;flex: 100%;background:white;">
                                        <button style="width: calc(103% - 1.2rem);padding: 5%;background: #2C71EC;color: white;border: none;" type="submit" id="cash_out_submit" class="cash_out_submit">CASH OUT</button>
                                </div> <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        inner join wallet on wallet.wallet_id = linked_card.wallet_id
                                        inner join hei on hei.hei_id = student.hei_id
                                        where transaction_type = '3' and wallet_name = 'Squidew Wallet' and transaction.transaction_id= '".$filtervalues."'";
...
$(document).ready(function() {
    ...
    $("#cash_out_submit").click(function() {
        //Add trapping
        if(document.getElementById("cash_out_student_id").value ==""){
        alert("Error: Student ID Number Field cannot be empty! Please try again...");    
        }
        else if(document.getElementById("cash_out_amount").value ==""){
            alert("Error: Cash Out Amount Field cannot be empty! Please try again...");    
        }
        else{
            var id = document.getElementById("cash_out_student_id").value;
            if(validateid(id)==true){
                
            
                $.ajax({
            url: 'Functions/PHP/student_cash_out.php',
            type: 'post',
            data: {
                student_id: $("#cash_out_student_id").val(),
                cashier_id:  localStorage.getItem("cashier_id"),
                total_amount: $("#cash_out_amount").val(),
            },
            success: function(result) {
                        if(result.toString() == "insufficient"){
